"""Cineby: front page -> a current title -> episode -> every hoster it offers.
...
this module and collects nothing, and a push stays green regardless.
    ...
    python tests/test_providers_cineby.py
    python tests/test_providers_cineby.py voe dood   # only matching hosters
"""
...
if __name__ == "__main__":
    sys.exit(run_site("Cineby", "fetch_cineby_movies", [a.lower() for a in sys.argv[1:]]))
