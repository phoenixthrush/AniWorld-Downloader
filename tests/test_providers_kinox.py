"""Kinox: front page -> a current title -> episode -> every hoster it offers.
...
this module and collects nothing, and a push stays green regardless.
    ...
    python tests/test_providers_kinox.py
    python tests/test_providers_kinox.py voe dood   # only matching hosters
"""
