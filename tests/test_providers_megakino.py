"""MegaKino: front page -> a current title -> episode -> every hoster it offers.
...
this module and collects nothing, and a push stays green regardless.
    ...
    python tests/test_providers_megakino.py
    python tests/test_providers_megakino.py voe dood   # only matching hosters
"""
